...
def generate_launch_description():
    ...
    # Kinematics
    kinematics = load_yaml("universal_robot_ign","resource/ur5_moveit_config/kinematics.yaml")
    ...
    # Planning
    ompl_yaml = load_yaml("universal_robot_ign","resource/ur5_moveit_config/ompl_planning.yaml")
    planning = {"move_group": {
